...
HEAD_TAGS = """<link rel="stylesheet" href="/assets/talata-nav.css?v=20260915a">
<link rel="icon" href="/favicon.svg" type="image/svg+xml">
<link rel="icon" href="/favicon.ico" sizes="32x32">
<link rel="apple-touch-icon" href="/apple-touch-icon.png">
<meta name="theme-color" content="#0B0F17">"""

DARK_TAG = '<link rel="stylesheet" href="/assets/talata-dark.css?v=20260915a">'

SCRIPT_TAG = '<script src="/assets/talata-nav.js?v=20260915a" defer></script>'
...
def process(path: Path, check: bool):
    ...
    if "/assets/talata-nav.css?v=20260915a" not in src:
    ...
    if "/assets/talata-nav.js?v=20260915a" not in src:
