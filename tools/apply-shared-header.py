...
SKIP = {
    ...
    "tools/og-horsholm-cup.html",  # static share card generator, rendered by hand
}
...
CTA = {
    ...
    "camps/academy-u16-camp-2026.html": ("#waitlist", "Sign up"),
    "camps/academy-u12-camp-2026.html": ("#waitlist", "Sign up"),
    "camps/college-pathway-camp-2026.html": ("#waitlist", "Sign up"),
...
MENU = {
    ...
    "Games": [],
    # Merged 26 Aug 2026 (Deng: "prices and times can go into club"). Four tabs
    # now, and Club runs to six rows, which is still the longest dropdown.
    # The 25 Aug audit finding that made Prices its own tab stands: prices were
    # three clicks deep and the word "price" appeared in neither nav nor footer.
    # So it keeps the FIRST row here and it is labelled "Prices", not "What it
    # costs" -- the word has to survive the merge even though the tab did not.
    "Club": [
        ("/help/age-groups", "Prices", "fees and age groups"),
...
HEAD_TAGS = """<link rel="stylesheet" href="/assets/talata-nav.css?v=20260917a">
<link rel="icon" href="/favicon.svg" type="image/svg+xml">
<link rel="icon" href="/favicon.ico" sizes="32x32">
<link rel="apple-touch-icon" href="/apple-touch-icon.png">
<meta name="theme-color" content="#0B0F17">"""

DARK_TAG = '<link rel="stylesheet" href="/assets/talata-dark.css?v=20260917a">'

SCRIPT_TAG = '<script src="/assets/talata-nav.js?v=20260917a" defer></script>'
...
def process(path: Path, check: bool):
    ...
    if "/assets/talata-nav.css?v=20260917a" not in src:
    ...
    if "/assets/talata-nav.js?v=20260917a" not in src:
