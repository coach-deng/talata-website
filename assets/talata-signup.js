...
(function (global) {
  ...
  function kindOf(out, data) {
    ...
    // 17 Sep 2026: Academy U16 Camp is Academy U15 Camp. U15 and U16 both read as a camp.
    if (/(starter|academy|pathway)\s*camp|academy\s*u\s*1[256]\s*camp/.test(label)) return 'camp';
